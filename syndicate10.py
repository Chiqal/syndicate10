...
admin = ["u22ed21bd97a4291726fa53b756ce2f01","u2c723b29dd222fe3f6bf70304c476230","ufd446574ba860923aeb438c933c836ce","ufafdbacbff38226d151940789db301d7","u1419826892f933d1280d8f59a485a929","u98a5ab007afdcc8ba74a33b778bc65f4"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    ...
    #--------------= SC Ganti nama Owner=--------------
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki3.updateProfile(profile)
                    ki3.sendText(msg.to,"Update Name : " + string + "")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki4.updateProfile(profile)
                    ki4.sendText(msg.to,"Update Name : " + string + "")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki5.updateProfile(profile)
                    ki5.sendText(msg.to,"Update Name : " + string + "")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki6.updateProfile(profile)
                    ki6.sendText(msg.to,"Update Name : " + string + "")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki7.updateProfile(profile)
                    ki7.sendText(msg.to,"Update Name : " + string + "")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki8.updateProfile(profile)
                    ki8.sendText(msg.to,"Update Name : " + string + "")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki9.updateProfile(profile)
                    ki9.sendText(msg.to,"Update Name : " + string + "")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki10.updateProfile(profile)
                    ki10.sendText(msg.to,"Update Name : " + string + "")
    #-------------- copy profile----------
			...
			if wait["atjointicket"] == True:
              ...
              ##if msg.from_ in admin:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile_B = ki6.getProfile()
                    profile_B.displayName = string
                    ki6.updateProfile(profile_B)
                    ki6.sendText(msg.to,"name " + string + " done")
                    profile_B = ki7.getProfile()
                    profile_B.displayName = string
                    ki7.updateProfile(profile_B)
                    ki7.sendText(msg.to,"name " + string + " done")
                    profile_B = ki8.getProfile()
                    profile_B.displayName = string
                    ki8.updateProfile(profile_B)
                    ki8.sendText(msg.to,"name " + string + " done")
                    profile_B = ki9.getProfile()
                    profile_B.displayName = string
                    ki9.updateProfile(profile_B)
                    ki9.sendText(msg.to,"name " + string + " done")
                    profile_B = ki10.getProfile()
                    profile_B.displayName = string
                    ki10.updateProfile(profile_B)
            ...
            #----------------Fungsi Unbanned User Target Start-----------------------#
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        ki6.sendText(msg.to,"Tidak Ditemukan.....")
                        ki7.sendText(msg.to,"Tidak Ditemukan.....")
                        ki8.sendText(msg.to,"Tidak Ditemukan.....")
                        ki9.sendText(msg.to,"Tidak Ditemukan.....")
                        ki10.sendText(msg.to,"Tidak Ditemukan.....")
                    else:
                        for target in targets:
                            try:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                ki6.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki7.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki8.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki9.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki10.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
